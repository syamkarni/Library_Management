...
class AllBookAPI(Resource):
    def get(resource):
        ...
        book_list = []
        for book in books:
            book_list.append({'book_id': book.book_id, 'book_name': book.book_name, 'book_author': book.book_author, 'section_id' : book.section_id, 'pages': book.pages_in_book, 'content': book.content })
        return book_list
